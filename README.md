...
### Trạng thái Cơ sở dữ liệu chéo vùng (Multi-Region Database Replication State)

#### Trạng thái Bình thường (Normal State - Singapore replica sang Tokyo)
![RDS Normal Replication State](docs/images/1.png)

#### Trạng thái sau khi Failover (Promoted State - Tokyo thăng cấp thành Master)
![RDS Promoted State](docs/images/2.png)
...
#### Trạng thái Kustomizations của Flux CD trên cụm EKS Tokyo khi được kích hoạt:
![Flux CD Kustomizations Tokyo](docs/images/6.png)
...
### Minh chứng Cấu hình Tự động hóa Failover

#### 1. Thiết lập RDS Event Subscription & SNS Topic:
![RDS Event Subscription and SNS](docs/images/3.png)

#### 2. Cấu hình biến môi trường Lambda Function:
![Lambda Environment Variables](docs/images/4.png)

#### 3. Log thực thi Lambda trên CloudWatch khi chạy Failover:
![Lambda CloudWatch Logs](docs/images/5.png)
```
